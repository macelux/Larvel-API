    ...
    <form action="<?php echo e(route('register')); ?>" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" name="first_name" class="form-control <?php echo e($errors->has('first_name') ? 'is-invalid' : ''); ?>"
                   value="<?php echo e(old('firstname')); ?>" placeholder="<?php echo e(__('FirstName')); ?>" autofocus>
        ...
        <div class="input-group mb-3">
            <input type="text" name="last_name" class="form-control <?php echo e($errors->has('last_name') ? 'is-invalid' : ''); ?>"
                   value="<?php echo e(old('lastname')); ?>" placeholder="<?php echo e(__('LastName')); ?>" autofocus>
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-user <?php echo e(config('adminlte.classes_auth_icon', '')); ?>"></span>
                </div>
...
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'register'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Larvel-API\resources\views/vendor/adminlte/auth/register.blade.php ENDPATH**/ ?>